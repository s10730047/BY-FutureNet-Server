...
# import requests
# import json
# url = "https://goodinfo.tw/StockInfo/StockFinDetail.asp?RPT_CAT=IS_M_QUAR_ACC&STOCK_ID="
# headers = {
...
#         df = dfs[0]
#         df = df[df[0]=='每股稅後盈餘(元)']
#         Eps2021Q1 =df.iloc[0,1]
#         Eps2020Q4 =df.iloc[0,3]
#         Eps2020Q3 =df.iloc[0,5]
#         Eps2020Q2 =df.iloc[0,7]
#         Eps2020Q1 =df.iloc[0,9]
#         Eps2019Q4 =df.iloc[0,11]
#         Eps2019Q3 =df.iloc[0,13]
#         TrueEpsGrowPercent = (Eps2021Q1-Eps2020Q1)/Eps2020Q1
#         Eps.objects.create(
#             StockID = stockID,
#             EPS2021Q1=Eps2021Q1,
#             EPS2020Q4=Eps2020Q4,
...
while True:
    ...
    Eps2020Q4 =df.iloc[3,8]
    Eps2020Q3 =df.iloc[2,8]
    Eps2020Q2 =df.iloc[1,8]
    Eps2020Q1 =df.iloc[0,8] 
    Eps2019Q4 =df.iloc[3,7]
    Eps2019Q3 =df.iloc[2,7]
    Eps2019Q2 =df.iloc[1,7]
    Eps2019Q1 =df.iloc[0,7]
    ...
    print("預估今年EPS=",Estimate2021Eps)
    print("預估合理股價=",EstimateReasonablePrice)
